...
import { CartItem, CustomerDetails, ShopSettings } from "@/app/types";
import { formatNaira, generateWhatsAppURL } from "@/app/lib/utils";
          ...
          <>
            <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
              <p className="text-sm text-gray-500">
                Fill in your delivery details. Your order will be sent directly to the vendor on WhatsApp.
              </p>
              <Input
                label="Full Name"
            ...
            <div className="px-5 py-4 border-t border-gray-100 space-y-2">
              ...
              <Button variant="ghost" className="w-full" size="md" onClick={() => setStep("cart")}>
                ← Back to Cart
              </Button>
            </div>
          </>
